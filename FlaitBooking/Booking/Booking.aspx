<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booking.aspx.cs" Inherits="FlaitBooking.Booking.Booking" %>
...
<head runat="server">
	...
	<meta name="keywords" content="Flight Ticket Booking " />
...
<body>
    <form id="form1" runat="server">
        <div>
			...
			<asp:Button ID="btnLogout" runat="server" Text="Logout" BackColor="Red" Font-Bold="True" Font-Size="X-Large" Height="111px" OnClick="btnLogout_Click" Width="316px" />
			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="#" method="post">
							<div class="from">
								<h3>From</h3>
								<asp:TextBox ID="txtDepartureCity" class="city1" placeholder="Type Departure City" runat="server"></asp:TextBox>
							<%--	<input type="text" name="city" class="city1" placeholder="Type Departure City" required="">--%>
							</div>
							<div class="to">
								<h3>To</h3>
								<asp:TextBox ID="txtDestinationCity" class="city2" placeholder="Type Destination City" runat="server"></asp:TextBox>
							...
							<div class="date">
								...
								<div class="return">
									...
									<asp:TextBox ID="txtDateReturn" TextMode="Date"  runat="server"></asp:TextBox>
							...
							<div class="clear"></div>
							<asp:Button ID="btnSubmit" runat="server" Text="Confirm Booking" OnClick="btnSubmit_Click" />
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="#" method="post">
							...
							<div class="clear"></div>
							<asp:Button ID="btnSubmit2" runat="server" Text="Confirm Booking" OnClick="btnSubmit2_Click" />
				...
				<div class="load_more">	
						<ul id="myList">
							...
							<div class="clear"></div>
							<asp:Button ID="btnSubmit3" runat="server" Text="Confirm Booking" OnClick="btnSubmit3_Click" />
